    ...
    return (
        <>
            {audioReady && (
                <Card.Content className="audioRecorder">
                    <div className="audioRecorder-player">
                        <button
                            className="audioRecorder-btn stopBtn"
                            onClick={handleStop}
                        >
                        ...
                        >
                            <div
                                className={
                                    "audioRecorder-btn__icon audioRecorder-btn__icon--" +
                                    (playing ? "pause" : "play")
                                }
                            ></div>
                        </button>
                        ...
                        >
                            ...
                            <div className="audioRecorder-player_time">
                                <p className="played">
                                    {sToTime(audioRef.current.currentTime)}
                                </p>
                                <p className="total">
                                    {sToTime(audioRef.current.duration)}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <audio
                ...
                type="audio/mpeg"
                src={
                    audio.url ? `${process.env.REACT_APP_FILES_URL}/${audio.url}` : audio
                }
