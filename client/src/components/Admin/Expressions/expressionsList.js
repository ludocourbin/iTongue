        ...
        <Segment className="expressions-list" basic>
            <Segment>
                ...
                <Form onSubmit={handdleAddExpressionSubmit}>
                    <Form.Group>
                        <Form.Input
                            icon="add"
                            placeholder="Add a new expression"
                            width="16"
            ...
            <Segment className="expression-list__table">
                <Confirm
                    ...
                    content="Are you sur you want to delete the expression ?"
                    size="tiny"
                />
                ...
                <Table celled selectable sortable striped>
                    <Table.Header>
                        <Table.Row textAlign="center">
                            ...
                            <Table.HeaderCell>TanslationNbr</Table.HeaderCell>
                    ...
                    <Table.Body>
                        {expressionsList &&
                            expressionsList.map((expression, key) => (
                                <Table.Row
                                    textAlign="center"
                                    key={key}
                                ...
                                >
                                    ...
                                    <Table.Cell>{expression.label}</Table.Cell>
                                    <Table.Cell>
                                    ...
                                    <Table.Cell>
                                        <Icon
                                            ...
                                            link
                                            onClick={() =>
                                                handdleDeleteExpressionConfirm(
                                                    expression.id
                                                )
                                            }
                                        />
                                    ...
                                    <Table.Cell>
                                        <Icon
                                            ...
                                            link
                                            onClick={() =>
                                                handdleShowTraductionsByExpression(
                                                    expression.id
                                                )
                                            }
                                        />
