...
import { Image, Modal, Icon, Card, List } from 'semantic-ui-react';
import './style.scss';
...
const MyModal = ({
    ...
    switch (myAvatar) {
        case 'ludovic' :
            ...
            thisAvatar.picture ="https://itongue.s3.eu-west-3.amazonaws.com/uploads/avatars/5/6/5/7/aa0d3e447aac8a32fb8c3ae0a52c?v=1598599248039";
