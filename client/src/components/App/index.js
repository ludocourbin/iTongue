  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route path="/signup" render={() => (isLogged ? <Redirect to="/feed" /> : <Signup />)} />
        <Route path="/login" render={() => (isLogged ? <Redirect to="/feed" /> : <Login />)} />
        ...
        />
        <Route exact path="/feed" render={() => (isLogged ? <Feed /> : <Redirect to="/login" />)} />
        <Route
          exact
          path="/favoris"
