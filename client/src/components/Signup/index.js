...
import { Input, Checkbox, Button, Form, Container, Message, Icon } from "semantic-ui-react";
      ...
      <Container className="auth-form-container">
        <Form onSubmit={handleSubmit} size="large" className="signup">
          ...
          <Form.Field
            ...
            onChange={handleChange}
            value={password}
            icon={<Icon name={showPassword ? "eye slash" : "eye"} onClick={togglePassword} link />}
            placeholder="**********"
          />
          <Form.Field
            control={Input}
          ...
          <Form.Field
            ...
            id="terms"
            label={{
              children: "J'accepte les conditions générales d'utilisations"
            }}
          />

          {errorMessagePassword && <Message negative content={errorMessagePassword} />}
          {errorMessageEmail && <Message negative content={errorMessageEmail} />}
