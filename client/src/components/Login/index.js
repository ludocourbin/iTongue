...
import { Container, Button, Input, Form, Checkbox, Icon, Message } from "semantic-ui-react";
    ...
    <Layout titlePage="Login">
      <Container className="auth-form-container">
        ...
        <Form className="login-form" onSubmit={handleSubmit}>
          ...
          {loginErrorMessage && <Message content={loginErrorMessage} className="message_errors" />}
